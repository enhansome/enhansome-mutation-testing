...
* C#
  * [Stryker.NET](https://github.com/stryker-mutator/stryker-net) ⭐ 2,084 | 🐛 191 | 🌐 C# | 📅 2026-09-19 - A mutation-testing tool for .NET Framework and .NET.
...
* JavaScript
  * [StrykerJS](https://github.com/stryker-mutator/stryker) ⭐ 3,138 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-19 - A mutation-testing framework for JavaScript and TypeScript.
...
* Kotlin
  * [mutflow](https://github.com/anschnapp/mutflow) ⭐ 31 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-19 - A Kotlin library that performs mutation testing within the test suite after a single compilation.
...
* Python
  * [mutmut](https://github.com/boxed/mutmut) ⭐ 1,444 | 🐛 57 | 🌐 Python | 📅 2026-09-12
