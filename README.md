...
* C/C++
  * [Mull](https://github.com/mull-project/mull) ⭐ 838 | 🐛 23 | 🌐 C++ | 📅 2026-09-13 - An LLVM-based mutation-testing and fault-injection tool for C and C++.
...
* C#
  * [Stryker.NET](https://github.com/stryker-mutator/stryker-net) ⭐ 2,083 | 🐛 193 | 🌐 C# | 📅 2026-09-16 - A mutation-testing tool for .NET Framework and .NET.
...
* Crystal
  * [crytic](https://github.com/hanneskaeufler/crytic) ⭐ 70 | 🐛 4 | 🌐 Crystal | 📅 2026-09-16
* Elixir
...
* Go
  * [Gremlins](https://github.com/go-gremlins/gremlins) ⭐ 419 | 🐛 46 | 🌐 Go | 📅 2026-06-26
  * [Ooze](https://github.com/gtramontina/ooze) ⭐ 288 | 🐛 15 | 🌐 Go | 📅 2026-09-17
  * [go-mutesting](https://github.com/jonbaldie/go-mutesting) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2026-09-15
* Haskell
...
* Java/JVM
  * [PIT](https://github.com/hcoles/pitest) ⭐ 1,867 | 🐛 318 | 🌐 Java | 📅 2026-08-28 - A bytecode-level mutation-testing system for the JVM.
...
* JavaScript
  * [StrykerJS](https://github.com/stryker-mutator/stryker) ⭐ 3,132 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-16 - A mutation-testing framework for JavaScript and TypeScript.
...
* Kotlin
  ...
  * [mutflow](https://github.com/anschnapp/mutflow) ⭐ 29 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-17 - A Kotlin library that performs mutation testing within the test suite after a single compilation.
* PHP
...
* Python
  * [mutmut](https://github.com/boxed/mutmut) ⭐ 1,443 | 🐛 57 | 🌐 Python | 📅 2026-09-12
  * [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 658 | 🐛 52 | 🌐 Python | 📅 2026-08-09
* R
...
* Ruby
  * [Mutant](https://github.com/mbj/mutant) ⭐ 2,192 | 🐛 124 | 🌐 Ruby | 📅 2026-09-17
...
* Rust
  * [cargo-mutants](https://github.com/sourcefrog/cargo-mutants) ⭐ 1,304 | 🐛 110 | 🌐 Rust | 📅 2026-08-23 - A Cargo-based mutation-testing tool for Rust.
...
* OCaml
  * [Mutaml](https://github.com/jmid/mutaml) ⭐ 75 | 🐛 12 | 🌐 OCaml | 📅 2026-09-16
* Lean
  * [Mutate.lean](https://github.com/jubnzv/Mutate.lean) ⭐ 4 | 🐛 0 | 🌐 Lean | 📅 2026-09-11
* Other
  ...
  * [Universal Mutator](https://github.com/agroce/universalmutator) ⭐ 163 | 🐛 6 | 🌐 Python | 📅 2026-05-20 - A regular-expression-based mutation tool for source code in multiple languages.
...
* [gatecheck](https://github.com/simin-yuan/self-auditing-agent) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - A mutation-testing harness for validators and quality gates rather than for program code: it mutates the checker's input, reruns the checker for each mutant, and reports which mutations the gate fails to reject.
