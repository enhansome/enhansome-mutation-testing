...
* C#
  * [Stryker.NET](https://github.com/stryker-mutator/stryker-net) ⭐ 2,074 | 🐛 199 | 🌐 C# | 📅 2026-09-12 - A mutation-testing tool for .NET Framework and .NET.
...
* Go
  ...
  * [go-mutesting](https://github.com/jonbaldie/go-mutesting) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2026-09-11
* Haskell
...
* Java/JVM
  * [PIT](https://github.com/hcoles/pitest) ⭐ 1,865 | 🐛 318 | 🌐 Java | 📅 2026-08-28 - A bytecode-level mutation-testing system for the JVM.
...
* JavaScript
  * [StrykerJS](https://github.com/stryker-mutator/stryker) ⭐ 3,107 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-11 - A mutation-testing framework for JavaScript and TypeScript.
...
* Python
  * [mutmut](https://github.com/boxed/mutmut) ⭐ 1,434 | 🐛 60 | 🌐 Python | 📅 2026-09-12
...
* Rust
  * [cargo-mutants](https://github.com/sourcefrog/cargo-mutants) ⭐ 1,289 | 🐛 103 | 🌐 Rust | 📅 2026-08-23 - A Cargo-based mutation-testing tool for Rust.
