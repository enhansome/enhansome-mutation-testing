...
* C/C++
  * [Mull](https://github.com/mull-project/mull) ⭐ 837 | 🐛 23 | 🌐 C++ | 📅 2026-09-13 - An LLVM-based mutation-testing and fault-injection tool for C and C++.
...
* C#
  * [Stryker.NET](https://github.com/stryker-mutator/stryker-net) ⭐ 2,083 | 🐛 191 | 🌐 C# | 📅 2026-09-19 - A mutation-testing tool for .NET Framework and .NET.
...
* Go
  * [Gremlins](https://github.com/go-gremlins/gremlins) ⭐ 420 | 🐛 46 | 🌐 Go | 📅 2026-06-26
  * [Ooze](https://github.com/gtramontina/ooze) ⭐ 288 | 🐛 15 | 🌐 Go | 📅 2026-09-17
  * [go-mutesting](https://github.com/jonbaldie/go-mutesting) ⭐ 5 | 🐛 1 | 🌐 Go | 📅 2026-09-19
* Haskell
...
* JavaScript
  * [StrykerJS](https://github.com/stryker-mutator/stryker) ⭐ 3,136 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-16 - A mutation-testing framework for JavaScript and TypeScript.
...
* Ruby
  * [Mutant](https://github.com/mbj/mutant) ⭐ 2,193 | 🐛 124 | 🌐 Ruby | 📅 2026-09-17
