...
* Java/JVM
  * [PIT](https://github.com/hcoles/pitest) ⭐ 1,870 | 🐛 318 | 🌐 Java | 📅 2026-08-28 - A bytecode-level mutation-testing system for the JVM.
...
* Solidity / Smart Contracts
  * [Gambit](https://github.com/Certora/gambit) ⭐ 211 | 🐛 11 | 🌐 Rust | 📅 2026-08-12 - A mutation generator for improving specifications and test suites for Solidity contracts.
...
* [greencheck](https://github.com/simin-yuan/greencheck) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - A mutation-testing harness for validators and quality gates rather than for program code: it mutates the checker's input, reruns the checker for each mutant, and reports which mutations the gate fails to reject.
